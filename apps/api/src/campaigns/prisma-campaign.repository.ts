...
function toTargetRecord(row: any): CampaignTargetRecord {
  return {
    ...
    tiktokPrivacyLevel: row.tiktokPrivacyLevel ?? null,
    tiktokDisableComment: row.tiktokDisableComment ?? null,
    tiktokDisableDuet: row.tiktokDisableDuet ?? null,
    tiktokDisableStitch: row.tiktokDisableStitch ?? null,
    instagramCaption: row.instagramCaption ?? null,
    instagramShareToFeed: row.instagramShareToFeed ?? null,
    createdAt: row.createdAt instanceof Date ? row.createdAt.toISOString() : row.createdAt,
    updatedAt: row.updatedAt instanceof Date ? row.updatedAt.toISOString() : row.updatedAt,
  };
}
  ...
  async create(record: CampaignRecord): Promise<CampaignRecord> {
    const row = await this.prisma.campaign.create({
      data: {
        ...
        schedulePattern: record.schedulePattern ?? null,
  ...
  async addTarget(campaignId: string, target: CampaignTargetRecord): Promise<CampaignTargetRecord | null> {
    ...
    const row = await this.prisma.campaignTarget.create({
      data: {
        ...
        tiktokPrivacyLevel: target.tiktokPrivacyLevel ?? null,
        tiktokDisableComment: target.tiktokDisableComment ?? null,
        tiktokDisableDuet: target.tiktokDisableDuet ?? null,
        tiktokDisableStitch: target.tiktokDisableStitch ?? null,
        instagramCaption: target.instagramCaption ?? null,
        instagramShareToFeed: target.instagramShareToFeed ?? null,
