(() => {
  ...
  [
    ...
    ['Agora', 'Now'],
    ['Política de Privacidade', 'Privacy Policy', { pt: ['Politica de Privacidade'] }],
    ['Termos de Uso', 'Terms of Use', { pt: ['Termos de Servico', 'Termos de Serviço'] }],
    ['Exclusão de Dados', 'Data Deletion', { pt: ['Exclusao de Dados do Usuario', 'Exclusão de Dados do Usuário'] }],
    ...
    ['Conexao com YouTube indisponivel', 'YouTube connection unavailable'],
    ['Conectando...', 'Connecting...'],
    ['A API nao retornou a URL segura de autorizacao do Google.', 'The API did not return the secure Google authorization URL.'],
