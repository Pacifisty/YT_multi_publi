    ...
    projects: [
      ...
      },
      {
        test: {
          name: 'phase101',
          root: '.',
          include: ['tests/phase101/**/*.test.ts', 'tests/phase101/**/*.test.tsx'],
          environment: 'node',
        },
      },
      {
        test: {
          name: 'phase102',
          root: '.',
          include: ['tests/phase102/**/*.test.ts', 'tests/phase102/**/*.test.tsx'],
          environment: 'node',
        },
      },
      {
        test: {
          name: 'phase103',
          root: '.',
          include: ['tests/phase103/**/*.test.ts', 'tests/phase103/**/*.test.tsx'],
          environment: 'node',
        },
      },
      {
        test: {
          name: 'phase107',
          root: '.',
          include: ['tests/phase107/**/*.test.ts', 'tests/phase107/**/*.test.tsx'],
          environment: 'node',
        },
      },
      {
        test: {
          name: 'phase108',
          root: '.',
          include: ['tests/phase108/**/*.test.ts', 'tests/phase108/**/*.test.tsx'],
          environment: 'node',
        },
      },
    ],
